...
const EliminarAnimal = ({ codigo_ani }) => {
      ...
      try {
        ...
        if (result.isConfirmed) {
          ...
          const resp = await axios.delete(
            `${process.env.NEXT_PUBLIC_NEXTAUTH_URL}/api/animal/${codigo_ani}`
          );
          ...
          if (resp.status === 200) {
            ...
            router.push(
              `${process.env.NEXT_PUBLIC_NEXTAUTH_URL}/auth/dashboard/animal`
            );
            router.refresh();
          }
        }
        ...
        await Swal.fire(
          "Error",
          "Ocurrió un error al eliminar el animal.",
          "error"
        );
      }
    },
